...
import { CheckCircle2, Loader2, Send, ChevronDown, Paperclip, Mail, MessageCircle, Zap, Lock } from "lucide-react";
...
export default function ContactResumeForm({ activeTab, onTabChange }: any) {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <div>
            ...
            <h2 className="font-nunito font-black text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-[#0D1B2A] mb-4 sm:mb-6 leading-[1.15] lg:leading-[1.1]">
              Join the <br/>
